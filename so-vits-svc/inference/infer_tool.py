...
class Svc(object):
    def __init__(self, net_g_path, config_path,
        ...
        self.net_g_ms = None
        # print(config_path)
        config_path = "/ws1/zhaoqion/so-vits-svc/logs/44k/model/config.json"
        ...
        model = utils.get_hubert_model()
        print("======debug====load hubert model =====to xpu===")
        model = model.to("xpu")
        # print(self.hubert_model)
        # self.hubert_model = self.hubert_model.to("xpu")
        print("========================hubert model done=========================")
        self.load_model()
